...
public class ArquivoPalavras {
	...
	public static String lerArquivoPalavras() {
		...
		try {
			...
			/* Obtém o arquivo xml*/
			fileR = new FileReader("libs//Palavras.xml");
	...
	public static void escreverArquivoPalavras(String inserirNoArquivo) {
		
		/* Cria uma instância de File Reader -- Classe p/ interação c/ Arquivos */
		FileWriter filePalavras;
		...
		try {
			...
			/* Obtém o arquivo xml */
			filePalavras = new FileWriter("libs//Palavras.xml");
			
			/* Gera o Buffer p/ gravação */
			buff = new BufferedWriter(filePalavras);
			...
			System.out.println("\n\t\t   Verifique se o arquivo 'Palavras.xml' se encontra na pasta");
